...
`,locationsMap:{"logged-out":{startLoc:{col:46,line:18},endLoc:{col:74,line:18},startBody:{col:46,line:18},endBody:{col:74,line:18}},"logged-in":{startLoc:{col:46,line:18},endLoc:{col:74,line:18},startBody:{col:46,line:18},endBody:{col:74,line:18}}}},layout:"fullscreen"}},i=r(o=>e(a,{...o}),"Template"),P=i.bind({}),m=i.bind({});m.play=async({canvasElement:o})=>{const s=await l(o).getByRole("button",{name:/Log in/i});await d.click(s)};const L=["LoggedOut","LoggedIn"];export{m as LoggedIn,P as LoggedOut,L as __namedExportsOrder,S as default};
//# sourceMappingURL=Page.stories.d3009373.js.map
